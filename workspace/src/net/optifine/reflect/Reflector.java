...
public class Reflector
{
    ...
    public static ReflectorClass ChunkWatchEvent_UnWatch = new ReflectorClass("net.minecraftforge.com.albonec.othercode.event.world.ChunkWatchEvent$UnWatch");
    ...
    public static ReflectorClass DrawScreenEvent_Pre = new ReflectorClass("net.minecraftforge.client.com.albonec.othercode.event.GuiScreenEvent$DrawScreenEvent$Pre");
    ...
    public static ReflectorClass DrawScreenEvent_Post = new ReflectorClass("net.minecraftforge.client.com.albonec.othercode.event.GuiScreenEvent$DrawScreenEvent$Post");
    ...
    public static ReflectorClass EntityViewRenderEvent_CameraSetup = new ReflectorClass("net.minecraftforge.client.com.albonec.othercode.event.EntityViewRenderEvent$CameraSetup");
    ...
    public static ReflectorClass EntityViewRenderEvent_FogColors = new ReflectorClass("net.minecraftforge.client.com.albonec.othercode.event.EntityViewRenderEvent$FogColors");
    ...
    public static ReflectorClass ForgeEventFactory = new ReflectorClass("net.minecraftforge.com.albonec.othercode.event.ForgeEventFactory");
    ...
    public static ReflectorClass RenderBlockOverlayEvent_OverlayType = new ReflectorClass("net.minecraftforge.client.com.albonec.othercode.event.RenderBlockOverlayEvent$OverlayType");
    ...
    public static ReflectorClass RenderItemInFrameEvent = new ReflectorClass("net.minecraftforge.client.com.albonec.othercode.event.RenderItemInFrameEvent");
    ...
    public static ReflectorClass RenderLivingEvent_Pre = new ReflectorClass("net.minecraftforge.client.com.albonec.othercode.event.RenderLivingEvent$Pre");
    ...
    public static ReflectorClass RenderLivingEvent_Post = new ReflectorClass("net.minecraftforge.client.com.albonec.othercode.event.RenderLivingEvent$Post");
    ...
    public static ReflectorClass RenderLivingEvent_Specials_Pre = new ReflectorClass("net.minecraftforge.client.com.albonec.othercode.event.RenderLivingEvent$Specials$Pre");
    ...
    public static ReflectorClass RenderLivingEvent_Specials_Post = new ReflectorClass("net.minecraftforge.client.com.albonec.othercode.event.RenderLivingEvent$Specials$Post");
    ...
    public static ReflectorClass WorldEvent_Load = new ReflectorClass("net.minecraftforge.com.albonec.othercode.event.world.WorldEvent$Load");
